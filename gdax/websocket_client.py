...
from gdax.gdax_auth import get_auth_headers,get_auth_dict
...
class WebsocketClient(object):
    ...
    def _connect(self):
        ...
        if self.auth:
            ...
            sub_params.update(get_auth_dict(timestamp, message, self.api_key,  self.api_secret, self.api_passphrase))
